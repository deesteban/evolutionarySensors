...
def getFitnessVal(callStr):
    url = "http://memento.evannai.inf.uc3m.es/age/alfa?c="
    url += callStr
...
if __name__ == '__main__':
    ...
    for x in range(N_CYCLES):
        if x % 5 == 0:
            ...
            print("\n---------Tiempo restante hasta criterio de parada: %dHr:%dMin:%dSec" % (
    ...
    outputFile = open("fitnessVal-base-base.csv", "w+")
